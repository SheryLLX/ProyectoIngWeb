...
import DateGrafico from '../DateGrafico/DateGrafico'
...
export default ({ dates }) => {
    ...
    if (status) {
        modalDate = (
            <ModalForm title="Info Date" onClose={handleClick} >
                {info.creator._id &&
                    <Fragment>
                        <div>
                ...
                <div>
                    _id date : {info._id} <br />
                    reason : {info.reason} <br />
                    {info.doctor ?
                        (<p>Doctor : {info.doctor} </p>) :
                        ''
                    }
                    createdAt : {info.createdAt} <br />
                    updatedAt : {info.updatedAt} <br />
                </div>
            </ModalForm>
        )
    }
            ...
            <div class="card text-center">
                <div class="card-header">
                    ...
                    <div style={{ marginBottom: 15 }}>
                        ...
                        />
                        <div>
                            <DateGrafico filterData={filterData()} />
                        </div>
                    </div>
                    {buttonSearch}
                </div>
